# https://github.com/NixOS/nixpkgs/blob/nixos-unstable/pkgs/applications/networking/instant-messengers/telegram/telegram-desktop/default.nix
{ lib
, source
, fetchpatch
, callPackage
...
stdenv.mkDerivation rec {
  ...
  meta = with lib; {
    description = "64gram Desktop messaging app";
    longDescription = ''
