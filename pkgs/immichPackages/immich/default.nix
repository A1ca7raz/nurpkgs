# https://github.com/NixOS/nixpkgs/pull/244803/files
{
  lib,
  pkgs,
  buildNpmPackage,
...
let
  ...
  open-clip-torch = python3.pkgs.buildPythonApplication rec {
  ...
  # TODO should be converted to top-level package
  clip-server = python3.pkgs.buildPythonApplication rec {
    pname = "clip-server";
    version = "0.8.2";
    pyproject = true;
